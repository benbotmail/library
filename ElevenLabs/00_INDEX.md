...
Last validated against upstream `elevenlabs/packages` commit: `a8c2d5dff4dbec0f0947918ea2dce13ff0961938`.

This pack documents **how the current ElevenLabs JavaScript/TypeScript SDK behaves now** (not a changelog).

## What this pack covers
- `@elevenlabs/client` v1.3.1 for agent conversations (WebSocket + WebRTC)
