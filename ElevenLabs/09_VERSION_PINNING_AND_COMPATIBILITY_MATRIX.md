...
|---|---|---|---|
| Core SDK | `@elevenlabs/client` | `1.3.1` | Scribe realtime: `keyterms` and `noVerbatim` options; VoiceConversation: unconditional interruption + playAudio clears fade-out (regression fix) |
