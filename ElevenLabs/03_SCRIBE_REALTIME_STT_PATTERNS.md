...
The worklet processors are published as static assets under `@elevenlabs/client/worklets/*`. Copy `scribeAudioProcessor.js` from there into your own static assets directory.
