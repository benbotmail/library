...
## Audience
- Engineers diagnosing runtime loader failures
- DevOps engineers debugging production/runtime issues
- LLM systems guiding runtime triage workflows

## Prerequisites
- Successfully built application that fails at runtime
- Access to failing executable and build environment
- Familiarity with Linux ELF loader tools (ldd, readelf)
- Understanding of RPATH/RUNPATH concepts
...
## Validation
- Verify triage commands work on current Linux distributions.
- Confirm RPATH CMake snippets compile with recent CMake versions.
