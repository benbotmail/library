...
## Audience
- Engineers selecting initial Trilinos build profiles
- Team leads establishing build conventions
- LLM systems recommending profile choices

## Prerequisites
- Familiarity with Trilinos build goals (debug, validation, HPC, CI)
- Understanding of environment constraints (compiler, MPI, TPL availability)
...
## Validation
- Confirm profile recommendations align with current Trilinos testing practices.
- Verify cross-referenced docs exist and describe the profiles mentioned.
- Re-check risk signals against common failure patterns seen in CI and support channels.
